...
if ! pip3 show pyinstaller &> /dev/null; then
    ...
    if [ $? -ne 0 ]; then
        ...
        echo "Try running with: sudo pip3 install pyinstaller"
        echo ""
        exit 1
    fi
    ...
    pip3 show pyinstaller | grep -E "^(Name|Version):"
fi
...
# --osx-bundle-identifier: Bundle identifier for macOS (reverse-DNS format)
pyinstaller --onefile --windowed --name "FacialExpression_4E13" --clean --osx-bundle-identifier "com.hkdse.student13.facialexpression" 4E13_preSBA2_GUI.py
